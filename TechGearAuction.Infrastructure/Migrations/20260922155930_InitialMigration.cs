    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BannedDevices", x => x.DeviceHash);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLoginDeviceHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BidIncrement = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Auction_BuyNowPrice", "[BuyNowPrice] IS NULL OR [BuyNowPrice] >= [StartPrice]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_Auctions_AuctionId",
                        column: x => x.AuctionId,
                        principalTable: "Auctions",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppealEvidences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppealEvidences_Appeals_AppealId",
                        column: x => x.AppealId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppealEvidences_AppealId",
                table: "AppealEvidences",
                column: "AppealId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuctionWatches_UserId_AuctionId",
                table: "AuctionWatches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditTransactions_AuctionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SuspiciousActivities_AuctionId",
                table: "SuspiciousActivities",
                column: "AuctionId");

            migrationBuilder.CreateIndex(
                name: "IX_SuspiciousActivities_BidderId",
                table: "SuspiciousActivities",
                column: "BidderId");

            migrationBuilder.CreateIndex(
                name: "IX_SuspiciousActivities_SellerId",
                table: "SuspiciousActivities",
                column: "SellerId");
